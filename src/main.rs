...
fn compute(s: Vec<u8>) -> String {
    array_to_hex_string(md5_array(s))
}

fn main() {
    let s = "BLUEPRINT:0,10,0,0,0,0,0,0,637657055979970390,0.8.20.8116,New%20Blueprint,\"H4sIAAAAAAAAC2NkQAWMUAxh/2dgOAFlMsKFGVapzzcHCx6Q3IbMhsn/47Bj+A8FCFMZGAC/wJi6bAAAAA==";
    let _s = "ED787AF7F9569A7FF9C0213711AFFFB7";
